...
Aşağıdaki akış, C++ temellerinden başlayıp gerçek zamanlı algılama modülüne (Perception Node) uzanan öğrenme yolunu göstermektedir.  
Her bölüm, bir sonrakini anlamak için temel oluşturur ve toplam **151 pratik örnek / algoritma / proje** içerir.
